...
<body>
	<div id="container">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown"><a
							...
							aria-expanded="false">domo</a>
							<div class="dropdown-menu" aria-labelledy="navbarDropdown">
								<a class="dropdown-item"
									href="${pageContext.request.contextPath }/domo/domo.do">domo
									등록</a> <a class="dropdown-item"
									href="${pageContext.request.contextPath }/domo/selectList.do">domo
									리스트</a>
							</div></li>
					</ul>
					<c:if test="${loggedMember == null }">
						...
						&nbsp;
						<button class="btn btn-outline-success my-2 my-sm-0" type="button" onclick="location.href='${path }/member/memberEnroll.do'">
							회원가입
						</button>
					</c:if>
					<c:if test="${loggedMember != null }">
						<span>
							<a href="#">${loggedMember.userName }</a>님 환영합니다.
						</span>
						&nbsp;
		...
		<!-- 로그인 모달 만들기 -->
		<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModelLabel" aria-hidden="true">
